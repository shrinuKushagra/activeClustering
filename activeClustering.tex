...
Note that this is a novel result, as the lower bound established in \cite{ben2014data} is for the general metric spaces (and does not apply to the Euclidean case).
