...
Note that this is a novel result, as the lower bound established in \cite{ben2014data} is for the general metric spaces (and no lower bound for the Euclidean case has been established before.
