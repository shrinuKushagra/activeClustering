...
Note that this is a novel result, as the lower bound established in \cite{ben2014data} does not apply to the Euclidean case. The following subsections are devoted to prove this theorem.
