...
We will also consider the case that the oracle answers to the queries conform with some optimal $k$-means solution. We then try to find out whether access to a 'reasonable' number of xxx queries can enable an efficient algorithm for an otherwise NP-hard problem. 
