...
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Centers \\ from data\end{tabular}} & & \begin{tabular}[c]{@{}l@{}}Upper bound - $\sqrt{2}+1$\\ Lower bound - 2\end{tabular} \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Centers from\\ metric space\end{tabular}} & & \begin{tabular}[c]{@{}l@{}}Upper bound - $2+\sqrt{3}$\\ Lower bound - 3\end{tabular} \\ \hline
\end{tabular}
\end{table}
